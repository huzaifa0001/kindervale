  ...
  function start(data) {
    ...
    function injectStyles() {
      ...
      s.textContent = `
        ...
        @keyframes rollGallery{from{transform:translate3d(0,0,0)}to{transform:translate3d(-33.333%,0,0)}}
